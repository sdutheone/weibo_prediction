...
if __name__ == '__main__':
    ...
    for category in categories:
        infilenames = [item['path'] + '.eventtime.trw' for item in events if item['category'] == category and item['usage'] == 'Train']
    ...
    for category in categories:
        infilenames = [item['path'] + '.eventtime.trw.common' for item in events if item['category'] == category and item['usage'] == 'Test']
        outdirname = zhang2012['outdirname']
    ...
    for infilename1, infilename2, outfilename in zip(infilenames1, infilenames2, outfilenames):
        ...
        predict_rtnums(infilename1, infilename2, outfilename, simthreshold, pm)
